...
from upstash_redis.typing import FloatMinMaxT, GeoSearchResult, Value
...
class Commands:
    ...
    def hmset(self, key: str, values: Dict[str, Value]) -> bool: ...
    def hrandfield(
    ...
    def hsetnx(self, key: str, field: str, value: Value) -> bool: ...
    ...
    def lrem(self, key: str, count: int, element: Value) -> int: ...
    ...
    def sismember(self, key: str, member: Value) -> bool: ...
    def smismember(self, key: str, *members: Value) -> List[bool]: ...
    ...
    def mset(self, values: Dict[str, Value]) -> Literal[True]: ...
    def msetnx(self, values: Dict[str, Value]) -> bool: ...
...
class AsyncCommands:
    ...
    async def hmset(self, key: str, values: Dict[str, Value]) -> bool: ...
    ...
    async def hsetnx(self, key: str, field: str, value: Value) -> bool: ...
    ...
    async def lrem(self, key: str, count: int, element: Value) -> int: ...
    ...
    async def sismember(self, key: str, member: Value) -> bool: ...
    async def smismember(self, key: str, *members: Value) -> List[bool]: ...
    ...
    async def mset(self, values: Dict[str, Value]) -> Literal[True]: ...
    async def msetnx(self, values: Dict[str, Value]) -> bool: ...
    async def psetex(
