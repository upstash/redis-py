...
class Commands:
    ...
    def hmset(self, key: str, values: Dict[str, Any]) -> bool: ...
    def hrandfield(
    ...
    def mset(self, values: Dict[str, Any]) -> Literal[True]: ...
    def msetnx(self, values: Dict[str, Any]) -> bool: ...
...
class AsyncCommands:
    ...
    async def hmset(self, key: str, values: Dict[str, Any]) -> bool: ...
    ...
    async def mset(self, values: Dict[str, Any]) -> Literal[True]: ...
    async def msetnx(self, values: Dict[str, Any]) -> bool: ...
    async def psetex(
