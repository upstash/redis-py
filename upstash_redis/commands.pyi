...
class Commands:
    ...
    def hdel(self, key: str, *fields: str) -> List[int]: ...
    ...
    def hpersist(self, key: str, *fields: List[str]) -> int: ...
...
class AsyncCommands:
    ...
    async def httl(self, key: str, *fields: List[str]) -> List[int]: ...
    async def hpttl(self, key: str, *fields: List[str]) -> List[int]: ...
    async def hexpiretime(self, key: str, *fields: List[str]) -> List[int]: ...
    async def hpexpiretime(self, key: str, *fields: List[str]) -> List[int]: ...
    async def hpersist(self, key: str, *fields: List[str]) -> List[int]: ...
...
class PipelineCommands:
    ...
    def httl(self, key: str, *fields: List[str]) -> PipelineCommands: ...
    def hpttl(self, key: str, *fields: List[str]) -> PipelineCommands: ...
    def hexpiretime(self, key: str, *fields: List[str]) -> PipelineCommands: ...
    def hpexpiretime(self, key: str, *fields: List[str]) -> PipelineCommands: ...
    def hpersist(self, key: str, *fields: List[str]) -> PipelineCommands: ...
