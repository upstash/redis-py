...
class Commands:
    ...
    def expire(self, key: str, seconds: Union[int, datetime.timedelta]) -> bool: ...
    def expireat(self, key: str, unix_time_seconds: Union[int, datetime.datetime]) -> bool: ...
    def keys(self, pattern: str) -> List[str]: ...
    def persist(self, key: str) -> bool: ...
    def pexpire(self, key: str, milliseconds: Union[int, datetime.timedelta]) -> bool: ...
    def pexpireat(self, key: str, unix_time_milliseconds: Union[int, datetime.datetime]) -> bool: ...
...
class AsyncCommands:
    ...
    async def expireat(self, key: str, unix_time_seconds: Union[int, datetime.datetime]) -> bool: ...
    async def keys(self, pattern: str) -> List[str]: ...
    async def persist(self, key: str) -> bool: ...
    async def pexpire(self, key: str, milliseconds: Union[int, datetime.timedelta]) -> bool: ...
    async def pexpireat(self, key: str, unix_time_milliseconds: Union[int, datetime.datetime]) -> bool: ...
