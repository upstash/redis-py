...
class JsonCommands:
    ...
    def arrappend(self, key: str, path: str = '$', *value: JSONValueT) -> List[Union[int, None]]:...
    def arrindex(self, key: str, path: str, value: JSONValueT, start: int = 0, stop: int = 0) -> List[Union[int, None]]:...
    def arrinsert(self, key: str, path: str, index: int, *value: JSONValueT) -> List[Union[int, None]]:...
    def arrlen(self, key: str, path: str = '$') -> List[Union[int, None]]:...
    def arrpop(self, key: str, path: str = '$', index: int = -1) -> List[Union[JSONValueT, None]]:...
    def arrtrim(self, key: str, path: str = '$', start: int = 0, stop: int = 0) -> List[Union[int, None]]:...
    def clear(self, key: str, path: str = '$') -> int:...
    def delete(self, key: str, path: str = '$') -> int:...
    def forget(self, key: str, path: str = '$') -> int:...
    def get(self, key: str, path: Union[str, List[str]] = '$') -> Union[List[Union[JSONValueT, None]], JSONValueT]:...
    def merge(self, key: str, path: str, value: JSONValueT) -> Literal[True]:...
    def mget(self, keys: List[str], path: str) -> List[Union[JSONValueT, None]]:...
    def mset(self, key_path_value_tuples: List[Tuple[str, str, JSONValueT]]) -> Literal[True]:...
    def numincrby(self, key: str, path: str, increment: int) -> List[Union[int, None]]:...
    def nummultby(self, key: str, path: str, multiply: int) -> List[Union[int, None]]:...
    ...
    def set(self, key: str, path: str, value: JSONValueT, nx: Optional[bool] = None, xx: Optional[bool] = None) -> Literal[True]:...
    def strappend(self, key: str, path: str, value: str) -> List[Union[int, None]]:...
    def strlen(self, key: str, path: str = '$') -> List[Union[int, None]]:...
    def toggle(self, key: str, path: str = '$') -> List[Union[Literal[0, 1], None]]:...
    def type(self, key: str, path: str = '$') -> List[Literal["string", "integer", "boolean", "object", "array", "number", "null"]]:...
...
class PipelineJsonCommands:
    ...
    def arrindex(self, key: str, path: str, value: JSONValueT, start: int = 0, stop: int = 0) -> PipelineCommands:...
    def arrinsert(self, key: str, path: str, index: int, *value: JSONValueT) -> PipelineCommands:...
    def arrlen(self, key: str, path: str = '$') -> PipelineCommands:...
    def arrpop(self, key: str, path: str = '$', index: int = -1) -> PipelineCommands:...
    def arrtrim(self, key: str, path: str = '$', start: int = 0, stop: int = 0) -> PipelineCommands:...
    ...
    def get(self, key: str, path: Union[str, List[str]] = '$') -> PipelineCommands:...
    def merge(self, key: str, path: str, value: JSONValueT) -> PipelineCommands:...
    def mget(self, keys: List[str], path: str) -> PipelineCommands:...
    def mset(self, key_path_value_tuples: List[Tuple[str, str, JSONValueT]]) -> PipelineCommands:...
    ...
    def set(self, key: str, path: str, value: JSONValueT, nx: Optional[bool] = None, xx: Optional[bool] = None) -> PipelineCommands:...
...
class AsyncJsonCommands:
    ...
    async def arrappend(self, key: str, path: str = '$', *value: JSONValueT) -> List[Union[int, None]]:...
    async def arrindex(self, key: str, path: str, value: JSONValueT, start: int = 0, stop: int = 0) -> List[Union[int, None]]:...
    async def arrinsert(self, key: str, path: str, index: int, *value: JSONValueT) -> List[Union[int, None]]:...
    async def arrlen(self, key: str, path: str = '$') -> List[Union[int, None]]:...
    async def arrpop(self, key: str, path: str = '$', index: int = -1) -> List[Union[JSONValueT, None]]:...
    async def arrtrim(self, key: str, path: str = '$', start: int = 0, stop: int = 0) -> List[Union[int, None]]:...
    ...
    async def get(self, key: str, path: Union[str, List[str]] = '$') -> Union[List[Union[JSONValueT, None]], JSONValueT]:...
    async def merge(self, key: str, path: str, value: JSONValueT) -> Literal[True]:...
    async def mget(self, keys: List[str], path: str) -> List[Union[JSONValueT, None]]:...
    async def mset(self, key_path_value_tuples: List[Tuple[str, str, JSONValueT]]) -> Literal[True]:...
    async def numincrby(self, key: str, path: str, increment: int) -> List[Union[int, None]]:...
    async def nummultby(self, key: str, path: str, multiply: int) -> List[Union[int, None]]:...
    async def objkeys(self, key: str, path: str = '$') -> List[Union[List[str], None]]:...
    async def objlen(self, key: str, path: str = '$') -> List[Union[int, None]]:...
    async def resp(self, key: str, path: str = '$') -> List[List[JSONValueT]]:...
    async def set(self, key: str, path: str, value: JSONValueT, nx: Optional[bool] = None, xx: Optional[bool] = None) -> Literal[True]:...
    async def strappend(self, key: str, path: str, value: str) -> List[Union[int, None]]:...
    async def strlen(self, key: str, path: str = '$') -> List[Union[int, None]]:...
    async def toggle(self, key: str, path: str = '$') -> List[Union[Literal[0, 1], None]]:...
    async def type(self, key: str, path: str = '$') -> List[Literal["string", "integer", "boolean", "object", "array", "number", "null"]]:...