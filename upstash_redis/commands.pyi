...
class AsyncCommands:
    ...
    def bitfield_ro(self, key: str) -> "AsyncBitFieldRO": ...
    async def bitop(
        self, operation: Literal["AND", "OR", "XOR", "NOT"], destkey: str, *srckeys: str
    ) -> int: ...
    async def bitpos(
...
class AsyncBitFieldCommands:
    ...
    def get(self, encoding: str, offset: BitFieldOffset) -> "AsyncBitFieldCommands": ...
    def set(
        self, encoding: str, offset: BitFieldOffset, value: int
...
class AsyncBitFieldRO:
    def __init__(self, client: AsyncCommands, key: str): ...
    def get(self, encoding: str, offset: BitFieldOffset) -> "AsyncBitFieldRO": ...
    async def execute(self) -> List: ...
