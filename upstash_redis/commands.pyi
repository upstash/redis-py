...
class JsonCommands:
    ...
    def arrappend(
        self, key: str, path: str = "$", *value: JSONValueT
    ) -> List[Union[int, None]]: ...
    def arrindex(
    ...
    def type(
        ...
        Literal["string", "integer", "boolean", "object", "array", "number", "null"]
    ]: ...
