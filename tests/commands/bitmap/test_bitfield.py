...
async def test_set() -> None:
    async with redis:
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_set", "GET", "u8", "0") == [97]
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_set", "GET", "u8", "#1") == [115]
...
async def test_incrby() -> None:
    async with redis:
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_incrby", "GET", "u8", "0") == [117]
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_incrby", "GET", "u8", "#1") == [103]
...
async def test_chained_commands() -> None:
    async with redis:
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_chained_commands", "GET", "u8", "0") == [98]
...
async def test_overflow() -> None:
    async with redis:
        ...
        assert await execute_on_http("BITFIELD", "string_for_bitfield_overflow", "GET", "i8", "100") == [127]
